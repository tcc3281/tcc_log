...
export default function Header() {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 shadow-md py-4 sticky top-0 z-10">
      <div className="container mx-auto px-4 flex justify-between items-center">        <Link href={user ? '/topics' : '/'} className="text-xl font-bold text-indigo-600 dark:text-indigo-400 transition-colors">
          Journal App
        </Link>
        ...
        {isLoading ? (
          ...
          <div className="flex items-center gap-6">
            ...
            <Link 
              href="/login" 
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-4 py-2 rounded-md text-sm transition-colors shadow-md"
            >
              Login
            </Link>
            <Link 
