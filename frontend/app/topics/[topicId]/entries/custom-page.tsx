        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg border filter-btn-active ${
                showFilters 
        ...
        <>
          ...
          <div className="space-y-6">
            {filteredEntries.map((entry) => (
              <div 
                key={entry.entry_id} 
                className="card entry-item bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow"
              >
                <div className="p-6">
